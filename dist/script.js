...
export const Foo = () => {
    const [x, setX] = React.useState(2);
    const foo = React.createElement("div", {}, React.createElement("article", null), React.createElement("button", {
...
export const PropsTest = (props) => {
    ...
    return React.createElement("div", { innerText: "hi" }, React.createElement("button", {
...
export const SimpleParent = (props) => {
    const [x, setX] = React.useState(2);
    return React.createElement("div", null, React.createElement("button", {
        onclick: () => {
            // setTimeout(() => {
...
export const OuterWrapper = () => {
    ...
    }), toggleInner && React.createElement(InnerWrapper, { counter }), React.createElement(DualIncrementer, null), ...items.map((i) => React.createElement("div", null, React.createElement(RandomElement, null))), 
    // need to do some light debugging on this
    React.createElement(DualIncrementer, null), React.createElement(DualIncrementer, null)
    // React.createElement(DualIncrementer, null)
    );
};
export const InnerWrapper = ({ counter }) => {
...
export const MainComponent = ({ children }) => {
    ...
    // @ts-ignore
    TestContext.Provider, { value: { hello: x } }, React.createElement(LeafComponent, null), 
    // React.createElement(
    //   ContainerComponent,
    //   null,
    //   React.createElement(LeafComponent, null)
    ...
    React.createElement(DualIncrementer, null), 
    // React.createElement(DualIncrementer, null),
    React.createElement(ActionButton, null), React.createElement(OuterWrapper, null), React.createElement("div", { innerText: "memo'd x + 1: " + memoXPlusOne }), React.createElement("div", {
        style: "color:blue",
    }, React.createElement("button", {
        onclick: () => setX(x + 1),
...
const AddItemsTest = () => {
    ...
    }), React.createElement(ConditionalTest, null), ...items.map((item) => React.createElement("div", {
        innerText: item,
    })));
};
const ListTest = () => {
    const [prev, trigger] = React.useState(false);
    const x = Array.from({ length: 10 }).map(() => React.createElement(RandomElement, null));
    return React.createElement("span", { root: "me" }, React.createElement("button", {
        innerText: "re-render",
        onclick: () => {
            trigger(!prev);
        },
    }), React.createElement("div", { innerText: "what" }), ...x);
};
const Wrapper = () => {
...
const ListAndItemUnder = () => {
    ...
    return React.createElement("div", { style: "display:flex; flex-direction: column" }, React.createElement("button", {
        innerText: "add item",
...
if (typeof window === "undefined") {
    const { reactViewTree, reactRenderTree } = React.buildReactTrees(React.createElement(Increment, null));
    ...
    window.onload = () => {
        ...
        React.createElement(MainComponent, null, React.createElement(DataFetcher, null)), 
        // React.createElement(
        //   SimpleParent,
        //   null,
...
const IsItARootTHing = () => {
    return React.createElement("div", null, React.createElement(SimpleParent, null, React.createElement(SimpleChild, null)));
};
const DeadParent = () => {
    ...
    return React.createElement("div", {
        ...
        style: "color: orange",
    }), React.createElement(ConditionalTest, null), React.createElement(RenrenderedChild, null));
};
...
const Repro = () => {
    ...
    return React.createElement("div", {
        ...
        onclick: () => setToggleInner(!toggleInner),
        innerText: toggleInner ? "Hide Inner" : "Show Inner",
    }), toggleInner && React.createElement("div", { innerText: "pls break" }), React.createElement("div", null));
};
...
const ContextTest = () => {
    ...
    return React.createElement("span", { innerText: "test" + readContext.hello }, React.createElement(EvenLower, null));
};
const EvenLower = () => {
    const readContext = React.useContext(TestContext);
...
const ParentContextTest = () => {
    return React.createElement(
    // @ts-ignore
    TestContext.Provider, { value: { hello: 10 } }, React.createElement(ContextTest, null));
};
const DataFetcher = () => {
    ...
    return React.createElement("div", null, ...data.map((item) => React.createElement("div", { innerText: item.title })));
};
